        ...
        <section className=" container w-180 " >
            ...
            <main className=" flex flex-col gap-6 " >
                <div className=" grid grid-cols-1 md:grid-cols-2 gap-6 " >
                    <Formfeild fieldName={"customer.firstName"} labelText={'First  Name'} placeholder="Enter your first name" required  />
                    <Formfeild fieldName={'customer.lastName'} labelText={'Last  Name'} placeholder="Enter your last name"  />
                </div>
                <div className=" grid grid-cols-1 md:grid-cols-2 gap-6  " >
                    <Formfeild fieldName={'customer.email'} labelText={'Email'} type="Email" placeholder="Enter your email"  required />
