...
export default function Banner({imgpath,pagename}){
    return(
          <section className=" relative inner-banner z-0  p-5 w-[95%] rounded-xl mx-auto mt-8 h-96 border-2   bg-no-repeat bg-center bg-cover overflow-hidden " style={{backgroundImage:`url(${imgpath || "/bgPic.webp"})`}} >
