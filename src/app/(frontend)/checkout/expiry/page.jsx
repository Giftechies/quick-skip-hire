...
export default function Checkoutexpiry() {
        ...
        <div className="relative py-20 min-h-screen  " >
            ...
            >
                ...
                <div className="container py-10 text-center" >
                    Payment timeup (15 minuts).<div onClick={() => route.push("/")} style={{ cursor: "pointer", textDecoration: "underline" }} >You can retry your order.</div>
                </div>
            </form>
        </div >
    );
